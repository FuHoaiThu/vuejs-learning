...
var DynamicFragment = class extends VaporFragment {
			...
			try {
				if (isEmpty) {
					...
					if (this.anchorLabel && currentHydrationNode && isComment(currentHydrationNode, "teleport anchor")) {
						...
						if (parentNode$1) {
							queuePostFlushCb(() => {
								parentNode$1.insertBefore(this.anchor = markHydrationAnchor(/* @__PURE__ */ createComment(this.anchorLabel)), anchor.parentNode === parentNode$1 ? anchor : null);
							});
							return;
						}
					}
						...
						if (parentNode$3) {
							...
							if (reusableAnchor) {
								...
								queuePostFlushCb(() => {
									...
									parentNode$3.insertBefore(this.anchor = markHydrationAnchor(/* @__PURE__ */ createComment(this.anchorLabel)), nextNode);
								});
							}
							return;
						}
				...
				if (this.anchorLabel && !isValidBlock(this.nodes) && this.nodes instanceof Comment && isReusableDynamicFragmentAnchor(this.nodes, this.anchorLabel) && /* @__PURE__ */ parentNode(this.nodes)) {
					...
					if (currentHydrationNode !== this.anchor) {
						exitHydrationBoundary = enterHydrationBoundary(this.anchor);
						advanceAfterRestore = this.anchor;
					} else advanceHydrationNode(this.anchor);
					return;
				}
				if (this.anchorLabel && !isValidBlock(this.nodes) && this.nodes instanceof Comment && !/* @__PURE__ */ parentNode(this.nodes) && currentHydrationNode) {
					...
					if (parentNode$4) {
						...
						queuePostFlushCb(() => {
							parentNode$4.insertBefore(this.anchor = markHydrationAnchor(/* @__PURE__ */ createComment(this.anchorLabel)), nextNode);
						});
						return;
					}
				}
				...
				if (this.anchorLabel === "if" && currentSlotEndAnchor && isHydratingSlotFallbackActive() && !isValidBlock(this.nodes)) {
					...
					queuePostFlushCb(() => {
						...
						parentNode.insertBefore(this.anchor = markHydrationAnchor(/* @__PURE__ */ createComment(this.anchorLabel)), endAnchor);
					});
					return;
				}
				const forwardedSlot = this.forwarded;
				const slotAnchor = isSlot ? currentSlotEndAnchor : null;
				if (isSlot && (!forwardedSlot || isValidBlock(this.nodes)) || this.anchorLabel === "if" && isArray(this.nodes) && this.nodes.length > 1) {
				...
				queuePostFlushCb(() => {
					...
					parentNode$2.insertBefore(this.anchor = markHydrationAnchor(/* @__PURE__ */ createComment(this.anchorLabel)), anchor);
				});
			} finally {
	...
	update(render, key = render) {
		...
		setActiveSub(prevSub);
		if (isHydrating$1 && this.anchorLabel !== "slot") this.hydrate(render == null);
	}
...
var slotFallbackBoundaryCache = /* @__PURE__ */ new WeakMap();
	...
	if (isSuspenseEnabled && instance.suspense && instance.asyncDep && !instance.asyncResolved) {
		...
		instance.suspense.registerDep(instance, (setupResult) => {
			...
			try {
				...
				if (isHydrating$1) instance.deferredHydrationBoundary && instance.deferredHydrationBoundary();
			} finally {
...
//#endregion
export { setDynamicEvents as $, shallowReactive as $a, simpleSetCurrentInstance as $i, createStaticVNode as $n, knownTemplateRefs as $r, vModelDynamic as $t, defineVaporAsyncComponent as A, withMemo as Aa, pushWarningContext as Ai, activate as An, hydrateOnInteraction as Ar, getValue as At, isVaporComponent as B, getCurrentWatcher as Ba, resolveDynamicComponent as Bi, computed as Bn, isHydrating as Br, resolveTransitionProps as Bt, createKeyedFragment as C, watch as Ca, performAsyncHydrate as Ci, NULL_DYNAMIC_COMPONENT as Cn, getInheritedScopeIds as Cr, createApp as Ct, createTextNode as D, withCtx as Da, popWarningContext as Di, Teleport as Dn, handleError as Dr, ensureHydrationRenderer as Dt, createTemplateRefSetter as E, watchSyncEffect as Ea, popScopeId as Ei, Suspense as En, h as Er, defineSSRCustomElement as Et, delegateEvents as F, TriggerOpTypes as Fa, renderList as Fi, callWithAsyncErrorHandling as Fn, inject as Fr, nodeOps as Ft, remove as G, isShallow as Ga, setBlockTracking as Gi, createCanSetSetupRefChecker as Gn, isRuntimeOnly as Gr, unsafeToTrustedHTML as Gt, nthChild as H, isReactive as Ha, resolvePropValue as Hi, createAsyncComponentContext as Hn, isMapEqual as Hr, shouldSetAsProp as Ht, getDefaultValue as I, customRef as Ia, renderSlot as Ii, callWithErrorHandling as In, invalidateMount as Ir, normalizeContainer as It, setBlockHtml as J, onWatcherCleanup as Ja, setDevtoolsHook as Ji, createHydrationRenderer as Jn, isTeleportDisabled as Jr, useHost as Jt, renderEffect as K, markRaw as Ka, setCurrentInstance as Ki, createCommentVNode as Kn, isSetEqual as Kr, useCssModule as Kt, getRestElement as L, effect as La, resetShapeFlag as Li, checkTransitionMode as Ln, invokeDirectiveHook as Lr, patchProp as Lt, defineVaporCustomElement as M, EffectScope as Ma, queuePostFlushCb as Mi, baseEmit as Mn, hydrateOnVisible as Mr, hasCSSTransform as Mt, defineVaporSSRCustomElement as N, ReactiveEffect as Na, registerHMR as Ni, baseNormalizePropsOptions as Nn, initCustomFormatter as Nr, hydrate as Nt, createVaporApp as O, withDefaults as Oa, provide as Oi, Text$1 as On, hasInjectionContext as Or, ensureRenderer as Ot, delegate as P, TrackOpTypes as Pa, registerRuntimeCompiler as Pi, baseResolveTransitionHooks as Pn, initFeatureFlags as Pr, initDirectivesForSSR as Pt, setDOMProp as Q, ref as Qa, shouldUpdateComponent as Qi, createSlots as Qn, isValidHtmlOrSvgAttribute as Qr, vModelCheckboxUpdate as Qt, insert as R, effectScope as Ra, resolveComponent as Ri, cloneVNode as Rn, isAsyncWrapper as Rr, patchStyle as Rt, createInvoker as S, warnPropMismatch as Sa, openBlock as Si, MoveType as Sn, getFunctionalFallthrough as Sr, callPendingCbs as St, createSlot as T, watchPostEffect as Ta, performTransitionLeave as Ti, Static as Tn, guardReactiveProps as Tr, defineCustomElement as Tt, on as U, isReadonly as Ua, resolveTarget as Ui, createBaseVNode as Un, isMemoSame as Ur, shouldSetAsPropForVueCE as Ut, next as V, isProxy as Va, resolveFilter as Vi, createAppAPI as Vn, isKeepAlive as Vr, setVarsOnNode as Vt, prepend as W, isRef as Wa, resolveTransitionHooks$1 as Wi, createBlock as Wn, isMismatchAllowed as Wr, svgNS as Wt, setBlockText as X, reactive as Xa, setRef as Xi, createPropsRestProxy as Xn, isTemplateRefKey as Xr, vModelCheckbox as Xt, setBlockKey as Y, proxyRefs as Ya, setIsHydratingEnabled$1 as Yi, createInternalObject as Yn, isTemplateNode as Yr, useShadowRoot as Yt, setClass as Z, readonly as Za, setTransitionHooks as Zi, createRenderer as Zn, isVNode as Zr, vModelCheckboxInit as Zt, createComponentWithFallback as _, validateComponentName as _a, onRenderTracked as _i, ErrorCodes as _n, expose as _r, TransitionPropsValidators as _t, VaporKeepAlive as a, toStyleMap as aa, mergeProps as ai, vModelTextInit as an, toRefs as ao, defineComponent as ar, setStyle as at, createForSlots as b, warn as ba, onUnmounted as bi, KeepAlive as bn, getComponentName as br, baseApplyTranslation as bt, VaporTransitionGroup as c, useAsyncComponentState as ca, normalizeRef as ci, vShowHidden as cn, unref as co, defineModel as cr, template as ct, applyRadioModel as d, useInstanceOption as da, onBeforeMount as di, withModifiers as dn, normalizeClass as do, defineSlots as dr, vaporInteropPlugin as dt, ssrContextKey as ea, leaveCbKey as ei, vModelRadio as en, shallowReadonly as eo, createTextVNode as er, setDynamicProps as et, applySelectModel as f, useModel as fa, onBeforeUnmount as fi, xlinkNS as fn, normalizeProps as fo, devtools as fr, withAsyncContext as ft, createComponent as g, useTransitionState as ga, onMounted as gi, DeprecationTypes as gn, ensureVaporSlotFallback as gr, TransitionGroup as gt, child as h, useTemplateRef as ha, onErrorCaptured as hi, Comment$1 as hn, toHandlerKey as ho, ensureValidVNode as hr, Transition as ht, VaporFragment as i, toHandlers as ia, mergeModels as ii, vModelText as in, toRef as io, defineAsyncComponent as ir, setProp as it, defineVaporComponent as j, withScopeId as ja, queueJob as ji, assertNumber as jn, hydrateOnMediaQuery as jr, handleMovedChildren as jt, createVaporSSRApp as k, withDirectives as ka, pushScopeId as ki, VaporSlot as kn, hydrateOnIdle as kr, forceReflow as kt, applyCheckboxModel as l, useAttrs as la, normalizeVNode as li, vShowOriginalDisplay as ln, camelize as lo, defineOptions as lr, txt as lt, applyVShow as m, useSlots as ma, onDeactivated as mi, BaseTransitionPropsValidators as mn, toDisplayString as mo, endMeasure as mr, withVaporDirectives as mt, DynamicFragment as n, startMeasure as na, matches as ni, vModelSelectInit as nn, stop as no, currentInstance as nr, setHtml as nt, VaporTeleport as o, transformVNodeArgs as oa, nextTick as oi, vModelTextUpdate as on, toValue as oo, defineEmits as or, setText as ot, applyTextModel as p, useSSRContext as pa, onBeforeUpdate as pi, BaseTransition as pn, normalizeStyle as po, devtoolsComponentAdded as pr, withVaporCtx as pt, setAttr as q, onScopeDispose as qa, setCurrentRenderingInstance as qi, createElementBlock as qn, isTeleportDeferred as qr, useCssVars as qt, VaporElement as r, toClassSet as ra, mergeDefaults as ri, vModelSetSelected as rn, toRaw as ro, deactivate as rr, setInsertionState as rt, VaporTransition as s, unregisterHMR as sa, nextUid as si, vShow as sn, triggerRef as so, defineExpose as sr, setValue as st, compile as t, ssrUtils as ta, markAsyncBoundary as ti, vModelSelect as tn, shallowRef as to, createVNode as tr, setElementText as tt, applyDynamicModel as u, useId as ua, onActivated as ui, withKeys as un, capitalize as uo, defineProps as ur, useVaporCssVars as ut, createDynamicComponent as v, validateProps as va, onRenderTriggered as vi, ErrorTypeStrings as vn, flushOnAppMount as vr, VueElement as vt, createPlainElement as w, watchEffect as wa, performTransitionEnter as wi, SchedulerJobFlags as wn, getTransitionRawChildren as wr, createSSRApp as wt, createIf as x, warnExtraneousAttributes as xa, onUpdated as xi, MismatchTypes as xn, getCurrentInstance as xr, baseUseCssVars as xt, createFor as y, version as ya, onServerPrefetch as yi, Fragment as yn, getAttributeMismatch as yr, VueElementBase as yt, isFragment as z, getCurrentScope as za, resolveDirective as zi, compatUtils as zn, isEmitListener as zr, render as zt };

//# sourceMappingURL=vue.runtime.esm-bundler-DGPq7_U-.js.map